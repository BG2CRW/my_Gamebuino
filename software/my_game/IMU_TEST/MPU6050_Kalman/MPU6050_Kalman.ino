...
#define USING_HORIZON 0
#define USING_VERTICAL 1
...
void setup()
{
    ...
    {
#ifdef USING_VERTICAL
        accelgyro.getMotion6(&ax, &az, &ay, &gx, &gz, &gy); //读取六轴原始数值
...
void loop()
{
    ...
    if(gb.update()){
      ...
      gb.display.println(agx);
  
      gb.display.print(F("Roll:"));
      gb.display.println(agy);

      gb.display.print(F("Yaw:"));
      gb.display.println(agz);
    }
